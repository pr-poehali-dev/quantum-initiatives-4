...
export const cabinetApi = {
  ...
  uploadFirmware: (token: string, fileData: string, fileName: string, orderId?: number) =>
    call('upload_firmware', { file_data: fileData, file_name: fileName, order_id: orderId }, token),
};
